...
import { fetchTodoById, Todo } from '../services/todoService.js';
    ...
    <div className="max-w-3xl mx-auto px-4 py-8 md:py-12">
      ...
      {loading ? (
        ...
        <motion.div
          ...
          className="bg-white border border-slate-100 rounded-3xl shadow-md shadow-slate-100/40 overflow-hidden"
        >
          {/* Cover Header Accent */}
